           ...
           <form @submit.prevent="signup()">
               ...
               <div class="form-group">
                  ...
                  <select class="form-control" id="inlineFormCustomSelect" v-model="account_type">
                            ...
                            <option value="30,000">&#8358;30,000 to &#8358;46,000</option>
                            ...
                            <option value="200,000">&#8358;200,000 to &#8358;320,000</option> 
                            <option value="300,000">&#8358;300,000 to &#8358;480,000</option> 
                            <option value="400,000">&#8358;400,000 to &#8358;640,000</option> 
                            <option value="500,000">&#8358;500,000 to &#8358;800,000</option> 
