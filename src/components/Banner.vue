    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          ...
          <img class="carousel-img" src="../assets/images/manager2.jpg" alt="First slide" />
          <div class="carousel-caption">
            <h1 class="animate__animated animate__bounceIn">EARN 60% of YOUR <span class="orange">INITIAL INVESTMENT IN 4 DAYS</span></h1>
            <p>You can grow your initial investment to as much as 60% in 4 days or in 24 hours when you select our promo plans. This applies to only new members. No stories, no stress.</p>
        ...
        <div class="carousel-item">
          <div class="carousel-overlay"></div>
          <img class="carousel-img" src="../assets/images/banner3.jpeg" alt="Third slide" />
          <div class="carousel-caption">
